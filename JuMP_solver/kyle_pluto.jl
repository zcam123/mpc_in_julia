...
# ╔═╡ 5895df10-5b7d-11ed-1e20-659934242e94
begin
	using JuMP
	import Ipopt
	using Plots
...
# ╔═╡ cbf9d3cf-ad6c-4600-9334-ebc08475397a
ones(1, 5)

# ╔═╡ f0926946-14ab-4075-be22-47858c44a2dc
begin
...
# ╔═╡ 7e869250-30d6-4a4a-ba74-9f71f16f66c7
begin
	neuron = direct_model(HiGHS.Optimizer)
	set_silent(neuron)
...
# ╔═╡ d2672bc6-8fda-4e4c-b211-1e3290212110
J

# ╔═╡ de3a2622-2158-491f-b0f1-5a22604c70b5
y

# ╔═╡ 90198ca0-62f6-4541-a1e0-83f1c728fe91
x_error

# ╔═╡ 660e053a-ec0d-41fd-bc8e-7c87e5de3165
u_cost[1]

# ╔═╡ 35960263-a441-4472-a9bd-d3cddd5ded59
function sim(steps, x0, u_clamp=nothing)
	zs = zeros(steps)
	us = zeros(steps)
	x_current = x0
	for t in 1:steps
...
# ╔═╡ 3bb1af3c-477d-4a19-8274-783fb2d689b9
zs, us = sim(1000, zeros(4));

# ╔═╡ d4c8b815-1734-4e9c-a4bc-bd6cf944eea8
zs

# ╔═╡ d63ab444-fda4-4a38-a56c-f457b6809013
begin
